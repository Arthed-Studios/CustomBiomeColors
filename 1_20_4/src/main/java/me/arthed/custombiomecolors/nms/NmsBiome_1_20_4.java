...
public class NmsBiome_1_20_4 implements NmsBiome {

    private final BiomeBase biomeBase;

    public NmsBiome_1_20_4(BiomeBase biomeBase) {
    ...
    public NmsBiome cloneWithDifferentColors(NmsServer nmsServer, BiomeKey newBiomeKey, BiomeColors biomeColors) {
        ResourceKey<BiomeBase> customBiomeKey = ResourceKey.a(Registries.at, new MinecraftKey(newBiomeKey.key, newBiomeKey.value));
        ...
        return new NmsBiome_1_20_4(customBiome);
    }
