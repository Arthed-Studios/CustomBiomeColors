...
public class NmsServer_1_20_4 implements NmsServer {
    private final RegistryMaterials<BiomeBase> biomeRegistry = (RegistryMaterials<BiomeBase>) ((CraftServer) Bukkit.getServer()).getServer().aZ().d(Registries.at);

    @Override
    public NmsBiome getBiomeFromBiomeKey(BiomeKey biomeKey) {
        return new NmsBiome_1_20_4(this.biomeRegistry.a(ResourceKey.a(Registries.at, new MinecraftKey(biomeKey.key, biomeKey.value))));
    }

    @Override
    public NmsBiome getBiomeFromBiomeBase(Object biomeBase) {
        return new NmsBiome_1_20_4(((Holder<BiomeBase>) biomeBase).a());
    }

    @Override
    public boolean doesBiomeExist(BiomeKey biomeKey) {
        return this.biomeRegistry.a(ResourceKey.a(Registries.at, new MinecraftKey(biomeKey.key, biomeKey.value))) != null;
    }
    ...
    public void loadBiome(BiomeKey biomeKey, BiomeColors biomeColors) {
        ...
        ResourceKey<BiomeBase> customBiomeKey = ResourceKey.a(Registries.at, new MinecraftKey(biomeKey.key, biomeKey.value));
    ...
    public void setBlocksBiome(Block block, NmsBiome nmsBiome) {
        ...
        net.minecraft.world.level.chunk.Chunk chunk = nmsWorld.m(blockPosition);
        if (chunk != null) {
